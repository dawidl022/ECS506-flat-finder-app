...
import { ApiV1ListingsAccommodationGetSortByEnum, DefaultApi } from "@/generated/apis/DefaultApi";
...
const InfiniteListings: FC<AccommodationDetailsProps> = ({ location, radius, maxPrice, sources, sortBy, page=0, size=6 }) => {
